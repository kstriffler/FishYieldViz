...
// Tooltip mini-chart dimensions
const tooltipChartWidth = 200;
const tooltipChartHeight = 120;

// GeoJSON world map (using remote URL)
...
// Main map SVG + group for zooming
...
// Helper to safely get ISO3 code from GeoJSON features
...
Promise.all([
    ...
    // Filter to real 3-letter ISO codes
    ...
    // Will store currently visible area-chart series keys
    let currentAreaKeys = [];
    ...
    mapGroup.selectAll("path.country")
        ...
        .attr("class", "country")
        .attr("d", path)
        .attr("fill", "#f0f0f0") // will be recolored by updateMapColors
    ...
    function updateMapColors(year) {
        ...
        const colorMap = d3.scaleSequential(d3.interpolateGnBu)  // GnBu scale
            .domain([0, maxLog]);
    ...
    // initial coloring with latest year
    updateMapColors(maxYear);

    // ======================================================================
    // MAP TOOLTIP (LINE CHART, WITH FLIP NEAR EDGES)
// ======================================================================
...
// ======================================================================
    ...
    // ======================================================================
    // AREA-CHART TOOLTIP (HOVER OVER STACKED AREA)
// ======================================================================

    // Invisible overlay to capture mouse events over plot area
    ...
    function areaMousemove(event) {
        ...
        // Show tooltip so we can measure
        ...
        // Get x within plot space, map to nearest year
    ...
    // ======================================================================
    // LEGEND (CLICKABLE TO TOGGLE SELECTION)
// ======================================================================
